...
const AppliedJobs: React.FC<TableOneProps> = ({
  heading,
  tableData,
  loading,
  fetchData,
                    ...
                    >
                      ...
                      <td className="flex py-5 gap-2">
                        ...
                        <button
                          ...
                          className="bg-meta-1  text-white font-bold py-1 px-4 mx-2 rounded-md transition duration-300"
                        >
