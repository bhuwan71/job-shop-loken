...
const EmployerTable: React.FC<TableOneProps> = ({
  heading,
  tableData,
  loading,
  fetchData,
      ...
      <div className="relative  shadow-md sm:rounded-lg rounded-xl">
        ...
        <div className="overflow-x-auto ">
          {loading ? (
            ...
            <table className="w-full  h-[60vh]  text-sm text-left text-gray-500">
              <thead className="text-xs  bg-meta-1  text-gray-700 uppercase ">
                <tr>
